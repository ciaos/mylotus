...
func init() {
	...
	skeleton.RegisterCommand("lcount", "list online member count", commandCount)
}
...
func commandCount(args []interface{}) interface{} {
	return fmt.Sprintf("Player Count : %d", len(g.PlayerManager))
}
